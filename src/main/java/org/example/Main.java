...
public class Main {
    public static void main(String[] args) {
       /* Lutador[] lutadores = new Lutador[6];
        ...
        g[2] = new Gafanhoto("sergio", 23, "m", "sergiolinss");
        ...
        vizualizacao[2] = new Vizualizacao(g[2], v[1]);
        vizualizacao[0].avaliar(4);
        vizualizacao[1].avaliar(5);
        vizualizacao[2].avaliar(7);
